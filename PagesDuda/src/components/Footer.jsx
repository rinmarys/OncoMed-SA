          ...
          <div className="container-um-alinhamento">
            <div className="alinhamento-containers">
              ...
              <div className="container-dois-alinhamento">
                ...
                <ul>
                  <li><Link to='/SobreNós'className='estilo-texto-link'>Sobre nós</Link></li>
                  <li><Link to='/' className='estilo-texto-link'>Blog</Link></li>
                  <li><Link className='estilo-texto-link'>Agendamentos</Link></li>
                  <li><Link to='/Convênio'className='estilo-texto-link'>Convênios</Link></li>
                  <li><Link className='estilo-texto-link'>Equipe médica</Link></li>
                </ul>

                <p><Link to='/TermosUso' className='estilo-texto-azul-link'>Termos de uso</Link></p>
