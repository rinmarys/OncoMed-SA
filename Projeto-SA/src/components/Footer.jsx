      ...
      <div className="container-um-alinhamento">
        <div className="alinhamento-containers">
          ...
          <div className="container-dois-alinhamento">
            ...
            <ul>
              <li><Link to='/sobreNos' className='estilo-texto-link' onClick={handleScrollToTop}>Sobre nós</Link></li>
              <li><Link to='/blog' className='estilo-texto-link' onClick={handleScrollToTop}>Blog</Link></li>
              <li><Link to='/meusAgendamentos' className='estilo-texto-link' onClick={handleScrollToTop}>Agendamentos</Link></li>
              <li><Link to='/convenios' className='estilo-texto-link' onClick={handleScrollToTop}>Convênios</Link></li>
              <li><Link className='estilo-texto-link'>Equipe médica</Link></li>
            </ul>

            <p><Link to='/termosDeUso' className='estilo-texto-azul-link' onClick={handleScrollToTop}>Termos de uso</Link></p>
            <p><Link to='/politicaPrivacidade' className='estilo-texto-azul-link' onClick={handleScrollToTop}>Politica de privacidade</Link></p>
